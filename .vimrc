...
" Reference setup:
" https://www.youtube.com/watch?time_continue=23&v=gnupOrSEikQ&feature=emb_logo
...
"{ Yash: Configs - Mapping
" Call NERDTreeFind iff NERDTree is active, curr win  modifiable file & we're
" not in vimdiff
nmap <C-n> :NERDTreeToggle<CR>
" Highlight currently open buffer in NERDTree

" coc config
" Perform :CocInstall coc-snippets and :CocInstall coc-python
" Use :CocConfig snippets.editSnippets
let g:coc_global_extension = [
  ...
  \ 'coc-python'
  \ ]
" Coc config for prettier
" command! -nargs=0 Prettier :CocCommand prettier.formatFile

" Set up ctags: Ref
" https://medium.com/@mck.workman/how-to-browse-fastai-source-code-using-vim-87d9ef595ce1
" Setup tags to be able to jump around
 set tags=~/.tags
 set guifont="Mononoki Nerd Font 18"

" For vim-equinusocio-material
